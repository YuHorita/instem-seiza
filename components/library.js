export const designs = [
  { name: "ジュエリーデザイン", index: 0, x: 48, y: 14, caption: 0 },
  ...
  { name: "ソーシャルデザイン", index: 13, x: 11, y: 57, caption: 3 },
  { name: "書体デザイン", index: 14, x: 25, y: 57, caption: 1 },
  { name: "ウェブデザイン", index: 15, x: 65, y: 58, caption: 0 },
  { name: "家具デザイン", index: 16, x: 94, y: 58, caption: 1 },
  ...
  { name: "エシカルデザイン", index: 20, x: 75, y: 64, caption: 2 },
  { name: "インクルーシブデザイン", index: 21, x: 95, y: 64, caption: 0 },
  { name: "ブランドデザイン", index: 22, x: 13, y: 73, caption: 3 },
  { name: "グラフィックデザイン", index: 23, x: 39, y: 79, caption: 2 },
